...
const GRAD = {
  ...
  bone: ['#E8DCC8', '#C4A882', '#8B7355'],
  rust: ['#A07050', '#6B4423', '#3D2817'],
};
...
export function SymbolIcon({ id, size = 64, glowing = false }: Props) {
  return (
    ...
    >
      ...
      <ellipse cx="40" cy="40" rx="36" ry="34" fill="url(#glow)" />
      {render(id)}
    </svg>
  );
}
...
function render(id: SymbolId) {
  switch (id) {
    ...
    case 'spyglass':
      return (
        <g>
          ...
          <circle cx="28" cy="52" r="10" fill="none" stroke="url(#goldG)" strokeWidth="3" />
    ...
    case 'bell':
      return (
        <g>
          <path d="M28 55 L52 55 L48 32 Q40 22 32 32 Z" fill="url(#goldG)" stroke="#8B6914" strokeWidth="1.5" />
    ...
    case 'skull':
      return (
        <g>
          <ellipse cx="40" cy="38" rx="18" ry="20" fill="url(#goldG)" stroke="#8B6914" strokeWidth="1" />
    ...
    case 'crown':
      return (
        <g>
          <path d="M14 50 L20 28 L32 40 L40 20 L48 40 L60 28 L66 50 Z" fill="url(#goldG)" stroke="#8B6914" strokeWidth="1.5" />
          <rect x="14" y="50" width="52" height="8" rx="2" fill="url(#goldG)" />
    ...
    case 'chest':
      return (
        <g>
          <rect x="16" y="38" width="48" height="28" rx="3" fill="#5D3A1A" stroke="url(#goldG)" strokeWidth="2" />
          <path d="M16 38 L22 26 L58 26 L64 38 Z" fill="#8B4513" stroke="url(#goldG)" strokeWidth="2" />
          <rect x="34" y="42" width="12" height="14" rx="2" fill="url(#goldG)" />
    ...
    case 'wild':
      return (
        <g>
          <ellipse cx="40" cy="42" rx="20" ry="16" fill="url(#tealG)" opacity="0.9" />
